<%-- 
    ...
    Created on : 05-sep-2019, 0:53:25
    Author     : migol
--%>
...
<html>
    ...
    <head>
        ...
        <title>ELECCIÓNPLUS - Consulta propuesta</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <!-- Page Heading -->
                        <h1 class="h3 mb-4 text-gray-800">Consulta propuestas</h1>
                        ...
                        <%
                            ...
                            ArrayList<CandidatoVO> listaPropuestas = candidatoDAO.listarPropuestas(id_candidato);
                            if (listaPropuestas.size() == 0) {%>
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">No hay propuestas</h6>
                        </div>
                        <% } else {%>
                        <% for (int b = 1; b == 1; b++) {
                                    candidatoVO = listaPropuestas.get(b);%>
                        <div class="card shadow mb-4" style="width: 450px">


                            <div class="card-body">
                                <h4>Candidato <%=candidatoVO.getNombres_candidato()%> <%=candidatoVO.getPrimerapellido_candidato()%></h4>
                                ...
                                <div class="card shadow mb-4">
                                    ...
                                    <% for (int i = 0; i < listaPropuestas.size(); i++) {
                                              candidatoVO = listaPropuestas.get(i);
                                    %>
                                    <a href="#collapseCardExample" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
                                        <h6 class="m-0 font-weight-bold text-primary">  No [<%=candidatoVO.getNo_propuesta()%>] Propuesta </h6>
                                    </a>
