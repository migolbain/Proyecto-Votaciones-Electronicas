 ...
 * @author migol
 */
@WebServlet(name = "CandidatoControlador", urlPatterns = {"/Candidato"})
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        switch (opcion) {
            ...
            case 2: //Actualizar Registro
                ...
                if (candDAO.actualizarRegistro()) {

                    request.setAttribute("mensajeExito", "¡El candidato ha sido actualizado correctamente!");
                    request.getRequestDispatcher("GestionCandidato.jsp").forward(request, response);

                } else {
                    request.setAttribute("mensajeError", "¡El candidato NO pudo ser actualizado !");
                    request.getRequestDispatcher("GestionCandidato.jsp").forward(request, response);
                }
