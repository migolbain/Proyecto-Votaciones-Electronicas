 ...
 * @author migol
 */
@WebServlet(name = "ReporteVotosElectoralControlador", urlPatterns = {"/ReporteElectoral"})
public class ReporteVotosElectoralControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                ArrayList<VotoVO> conteovotos = votoDAO.reportejornadaelectoral(fecha);
                for (int i = 0; i < conteovotos.size(); i++) {
                    ...
                    tabla.addCell(votoVO.getFecha_Jornada());
                }
