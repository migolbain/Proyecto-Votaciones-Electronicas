 ...
 * @author migol
 */
@WebServlet(name = "ReporteNovotosControlador", urlPatterns = {"/ReporteNoVotos"})
public class ReporteNovotosControlador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                PdfPCell celda4 = new PdfPCell(new Paragraph("Jornada", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.GREEN)));
                PdfPCell celda5 = new PdfPCell(new Paragraph("Estado del Voto", FontFactory.getFont("Arial", 12, Font.BOLD, BaseColor.GREEN)));
                ...
                ArrayList<VotoVO> conteovotos = votoDAO.Conteonovotosreportes(jornada);
                for (int i = 0; i < conteovotos.size(); i++) {
                    ...
                    tabla.addCell(votoVO.getId_jornada());
                    tabla.addCell(votoVO.getEstado_voto());
                }
