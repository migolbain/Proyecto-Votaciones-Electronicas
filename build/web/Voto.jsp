<%-- 
    Document   : Voto
    Created on : 11-sep-2019, 21:27:09
    Author     : migol
--%>

<%@page import="modeloVO.UsuarioVO"%>
<%@page import="modeloVO.CandidatoVO"%>
<%@page import="modeloDAO.VotoDAO"%>
<%@page import="java.util.ArrayList"%>
<%@page import="modeloVO.VotoVO"%>
...
<html>
    <%
        ...
        } else if (usuVO.getEstado_voto().equals("No voto")) {%>
    ...
    <head>
        ...
        <title>ELECCIONPLUS - Votar</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h1 class="h3 mb-1 text-gray-800">Votaciones</h1>
                        <%
                            VotoVO votoVO = new VotoVO();
                            VotoDAO votoDAO = new VotoDAO();
                            ArrayList<VotoVO> consultaultimajornada = votoDAO.consultarultimajornada();
                            ...
                            for (int k = 0; k < consultaultimajornada.size(); k++) {
                                votoVO = consultaultimajornada.get(k);
                                int idjornadavotacion = Integer.parseInt(votoVO.getID_JornadaVotaciones());
                                if (votoVO.getEstado_JornadaVotacion().equals("Inactivo")) { %>
                        <div class="card-header py-3">
                            <h3 class="m-0 font-weight-bold text-primary">No hay una Jornada Electoral Activa</h3>
                        </div>
                        <% } else {
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card position-relative" style="width: 50%">
                                    ...
                                    <div class="card-body" style="text-align: center">
                                        ...
                                        <form method="post" action="Voto">                                                       

                                            <input type="hidden" value="<%=idjornadavotacion%>" name="textjornadavotaciones">
                                            <input type="hidden" value="<%=estado_voto%>" name="textestado_voto">
                                            <input type="hidden" value="<%=fecha%>" name="textfecha">
                                            <input type="hidden" value="<%=numero_id%>" name="textidvoto">
                                            <input type="hidden" value="<%=numero_voto%>" name="textno_voto">
                                            <input type="hidden" value="<%=votoVO.getId_persona()%>" name="textidpersona">
                                            <input type="hidden" value="<%=usuVO.getId_persona()%>" name="textidpersonavoto">
                                            <img src="CargaImagen?id=<%=votoVO.getId_persona()%>" style="width: 250px; height: 300px;" alt="" class="responsive"><br>
                                            <label for="" id="nom1" style="font-size: 20px"><%= votoVO.getNombres_candidato()%> <%= votoVO.getPrimerapellido_candidato()%></label>
                                            <button type="button" class="form-control bg-warning text-white" data-toggle="modal" data-target="#votoModal<%=i%>">Votar 

                                            </button><br>

                                            <div class="modal fade" id="votoModal<%=i%>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">¿Estás seguro de Votar por este Candidato?</div>
                                                        <div class="modal-body">Su sesión sera cerrada si lo hace</div>
                                                        <div class="modal-footer">
                                                            <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancelar</button>
                                                            <button class="btn btn-warning">Votar</button>
