<%-- 
    Document   : ReporteJornadaElectoral
    Created on : 29-nov-2019, 2:31:15
    Author     : migol
--%>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <form name="reporte" method="post" action="ReporteElectoral">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="card shadow mb-4" style="width: 450%">
                                            <div class="card-header py-3">
                                                <h6 class="m-0 font-weight-bold text-primary">Reporte de votos en PDF</h6>
                                            </div>
                                            <div class="card-body">
                                                Reporte del numero de votos en la jornada electoral
                                                <hr>
                                                <input name="textfecha" type="date" class="form-control"><br>
