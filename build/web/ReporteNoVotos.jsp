<%-- 
    Document   : Reporte
    Created on : 01-oct-2019, 3:29:25
    Author     : migol
--%>
...
<html> 
    ...
    <head>
        ...
        <title>ELECCIONPLUS - Reporte PDF</title>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <form name="reporte" method="post" action="ReporteEstadovoto">

                            <!-- Page Heading -->
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Reporte de votos en PDF</h1>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <!-- Basic Card Example -->
                                            ...
                                            <div class="card shadow mb-4" style="width: 350%; margin-left:250px;">
                                                <div class="card-header py-3">
                                                    <h6 class="m-0 font-weight-bold text-primary">Reporte de aprendices que no votaron en PDF</h6>
                                                </div>
                                                <div class="card-body">
                                                    Consulta de reporte de aprendices que no votaron en un PDF
                                                    <hr>   
                                                    <label for="">Jornada Electoral</label><input name="textfecha" type="date" class="form-control"><br>
                                                    <button class="form-control bg-warning text-white" type="submit" value="Visualizar PDF" name="botonver">Visualizar PDF</button>
                                                </div>
                                            </div>
