<%-- 
    Document   : ConteoVotos
    Created on : 23-sep-2019, 23:36:37
    Author     : migol
--%>
...
<head>
    ...
    <title>ELECCIONPLUS - Gestion votos</title>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="card shadow mb-4" style="width: 450%">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary">Fecha de conteo de votos</h6>
                                    </div>
                                    <form method="post" action="ConteoVotosReportes.jsp">
                                        <div class="card-body">
                                            Pon la fecha del día en que se realizaron los votos
                                            <hr>
                                            <input type="date" class="form-control" name="textfecha" required><br>                                               
                                            <button type="submit" class="form-control bg-warning text-white">Hacer Conteo</button>
                                        </div>
                                    </form>
                                </div>
