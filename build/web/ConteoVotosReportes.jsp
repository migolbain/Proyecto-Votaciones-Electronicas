<%-- 
    Document   : ConteoVotosReportes
    Created on : 26-sep-2019, 1:14:42
    Author     : migol
--%>
...
<head>
    ...
    <title>ELECCIONPLUS - Gestion votos reporte</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <form action="gvotos.html">
                        <!-- Page Heading -->
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Conteo de votos</h1>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <!-- Basic Card Example -->
                                    <div class="card shadow mb-4" style="width: 450%">
                                        <div class="card-header py-3">
                                            <h6 class="m-0 font-weight-bold text-primary">Reporte del conteo</h6>
                                        </div>
                                        <%
                                            ...
                                            ArrayList<VotoVO> conteovotos = votoDAO.Conteovotos(fecha);

                                            for (int i = 0; i < conteovotos.size(); i++) {
                                                votoVO = conteovotos.get(i);

                                        %>
                                        <% if (votoVO.getId_jornada().equals("1")) {%>
                                        <div class="card-body">
                                            <b>Nombre del candidato: <%=votoVO.getNombres_candidato()%> <%= votoVO.getPrimerapellido_candidato()%></b><br>
                                            <hr>
                                            <label for="">Jornada del candidato: Jornada Diurna</label><br>
                                            <label for="">Numero de votos: <%=votoVO.getNo_voto()%></label><br>
                                        </div>
                                        <% }%>
                                        <% if (votoVO.getId_jornada().equals("2")) {%>
                                        <div class="card-body">
                                            <b>Nombre del candidato: <%=votoVO.getNombres_candidato()%> <%= votoVO.getPrimerapellido_candidato()%></b><br>
                                            <hr>
                                            <label for="">Jornada del candidato: Jornada Nocturna</label><br>
                                            <label for=""></label><br>
                                            <label for="">Numero de votos: <%=votoVO.getNo_voto()%></label><br>
                                        </div>
                                        <% }%>
                                        <% if (votoVO.getId_jornada().equals("3")) {%>
                                        <div class="card-body">
                                            <div class="card-body">
                                                <b>Nombre del candidato: <%=votoVO.getNombres_candidato()%> <%= votoVO.getPrimerapellido_candidato()%></b><br>
                                                <label for="">Jornada del candidato: Jornada 24 Horas</label><br>
                                                <label for="">Nombre del candidato: <%=votoVO.getNombres_candidato()%> <%= votoVO.getPrimerapellido_candidato()%></label><br>
                                                <label for="">Numero de votos: <%=votoVO.getNo_voto()%></label><br>
                                            </div>
                                            <% }%>
                                            <% }%>
